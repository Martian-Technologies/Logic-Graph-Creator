...
WindowRenderer::WindowRenderer(Swapchain* swapchain, std::vector<VulkanFrameData>& frames)
...
void WindowRenderer::renderCommandBuffer(VulkanFrameData& frame, uint32_t imageIndex) {
	// preparation
