...
public:
	...
	void render(Frame& frame, const glm::mat4& viewMatrix, std::shared_ptr<Evaluator> evaluator, const Address& address, const std::vector<std::shared_ptr<VulkanChunkAllocation>>& chunks);
