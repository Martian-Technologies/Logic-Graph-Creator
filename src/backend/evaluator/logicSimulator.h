...
public:
    ...
    void registerGate(input_socket_id_t inputSocket, output_socket_id_t outputSocket, GateType type);
    void registerGate(input_socket_id_t inputSocket, std::vector<output_socket_id_t> outputSockets, GateType type);
    void registerGate(std::vector<input_socket_id_t> inputSockets, output_socket_id_t outputSocket, GateType type);
    void registerGate(std::vector<input_socket_id_t> inputSockets, std::vector<output_socket_id_t> outputSockets, GateType type);
