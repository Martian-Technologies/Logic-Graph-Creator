...
public:
	...
	inline const std::vector<ConnectionEnd>* getInputConnections(Position position) const {
	...
	inline const std::vector<ConnectionEnd>* getOutputConnections(Position position) const {
